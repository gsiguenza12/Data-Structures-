...
public class AssistantJack {
    ...
    /**
     * Increments the number of times Jack has been asked.
     */
    public void addTimesAsked()
    {
        this.timesAsked++;
    }

    /**
     * Returns the current tally of timesAsked.
     *
     * @return
     */
    ...
    /**
     * Sets the answer set for the assistant to use.
     *
     ...
     * Allows you to manually set the correctTheory instead of using one of the answer sets.
     *
     * @param theory
     */
    ...
    /**
     * Will report to the user whether their theory works or not.  It will return a number
    ...
    public int checkAnswer(int weapon, int location, int person) {
        ...
        if(wrongItems.size() == 0) {
            ...
            return wrongItems.get(0); // returns the value stored in the first index.
        }
        else {
            Random random = new Random();
